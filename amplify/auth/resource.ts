...
import { preSignUpAllowDomains } from "../function/preSignUp/resource";
import { postConfirmationAddUserToGroup } from "../function/postConfirmation/resource";
import { preAuthenticationLoginAttempts } from "../function/preAuthentication/resource";
...
export const auth = defineAuth({
  ...
  triggers: {
    preSignUp: preSignUpAllowDomains,
    postConfirmation: postConfirmationAddUserToGroup,
    preAuthentication: preAuthenticationLoginAttempts,
  },
});
